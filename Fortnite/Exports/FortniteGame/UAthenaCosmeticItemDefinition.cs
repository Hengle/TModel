...
namespace CUE4Parse.FN.Exports.FortniteGame
{
    public class UAthenaCosmeticItemDefinition : UFortAccountItemDefinition
    {
        ...
        public FPackageIndex[]? ItemVariants;
        ...
        public override void DeepDeserialize()
        {
            ...
            ItemVariants = GetOrDefault<FPackageIndex[]>(nameof(ItemVariants), Array.Empty<FPackageIndex>()); // TODO: Causes InvalidOperationException
